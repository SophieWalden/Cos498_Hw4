...
class Faction:
    ...
    # ################################################################
    def run_ai(self, factions, cities, units, gmap, move_cache, defecting_enabled, unit_dict, top_models):
        return self.ai.run_ai(self.ID, factions, cities, units, gmap, move_cache, defecting_enabled, unit_dict, top_models)
